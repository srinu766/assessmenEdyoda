...
const Body = ()=>{
    return(
        ...
        <h1 className="text-white ml-7 text-xl"><span className="text-blue-500 text-xl font-bold">100+</span> Job relevant courses</h1>
        </div>
        <div className="flex mt-6">
        <img src={Timer} className="w-8 h-8"/>
        <h1 className="text-white ml-7 text-xl"><span className="text-blue-500 text-xl font-bold">20,000+</span> Hours of content</h1>
        </div>

        <div className="flex mt-6">
        <img src={Live} className="w-8 h-8"/>
        <h1 className="text-white ml-7 text-xl"><span className="text-blue-500 text-xl font-bold">Exclusive</span>  webnar access</h1>
        </div>
        <div className="flex mt-6">
        <img src={Edu} className="w-8 h-8"/>
        <h1 className="text-white ml-7 text-xl"> Scholarship worth <span className="text-blue-500 text-xl font-bold" >₹94,500</span></h1>
        </div>
        <div className="flex mt-6">
        <img src={NoAdd} className="w-8 h-8"/>
        <h1 className="text-white ml-7 text-xl"><span className="text-blue-500 font-bold">Ad Free</span>  learning experience</h1>
        </div>
        </div>
        </div>
        
        <div className="ml-80 mt-10 bg-white  h-[570px] w-[370px] rounded-md ">
        <div >
            <form >
            <div className="mt-6">
                <button className="ml-24 bg-blue-600 px-2 rounded-full text-white">1</button><button className="ml-28 bg-blue-600 px-2 rounded-full text-white">2</button>
                <p><span className="ml-[85px] text-sm">Sign Up</span> <span className="ml-20 text-sm">Subscribe</span></p>
            ...
            <img src={razarPay}  className="py-6 ml-4 w-[90px]"/>
            </div>   
            </div>
            </form>
            </div>
